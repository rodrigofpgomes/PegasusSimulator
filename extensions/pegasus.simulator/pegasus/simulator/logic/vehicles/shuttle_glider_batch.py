...
| Description: Definition of the ShuttleGliderBatch class, which serves as the base class for batched shuttle glider vehicles.
"""
...
from pegasus.simulator.logic.thrusters import QuadraticThrustGliderCurveBatch
...
class ShuttleGliderBatchConfig:
    """
    Class used to configure a ShuttleGliderBatch vehicle.
    """
    ...
    def __init__(
        ...
        """
        Initialize the ShuttleGliderBatch configuration.
        """
        ...
        self.thrust_curve = QuadraticThrustGliderCurveBatch(config=dict(cfg) if cfg else {}, n_vehicles=n_vehicles, device = device)
...
class ShuttleGliderBatch(VehicleBatch):
    """ShuttleGliderBatch class - It defines a base interface for batched shuttle glider vehicles."""
    def __init__(
        self,
    ...
    def update(self, dt: float):
        ...
        if self._input_mode in ("rotor_velocity", "rotor_velocity_direct"):
            ...
            self._torques[:, self._body_index, :] = rolling_moment
