# Shuttle glider — shuttle_glider_v3_obs_rw

Ablation de reward: velocidade observada/logada, mas removida do custo principal; clipping ativo.
...
## Observações
- Dimensão configurada: `28`.
- Vetor `policy`: `[pos_error, vel_error, R_flat, ang_b, self._action_history_obs, rotor_speeds_norm]`.
