# Shuttle glider — shuttle_glider_v2

Muda para observação 31D com `goal_acc`, adiciona custo de velocidade e `cost_clip`.
...
- `died` = `died |= upright < self.cfg.min_upright`
...
- `terminated` = `terminated |= upright < self.cfg.min_upright`
