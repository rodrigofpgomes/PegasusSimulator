...
TOTAL_TRANSITIONS = DEFAULT_NUM_ENVS * ROLLOUTS * PPO_UPDATES
...
def _make_cfg() -> dict:
    ...
    cfg["experiment"] = {
        "directory": "",
        "experiment_name": "",
        "write_interval": ROLLOUTS * 10,
        "checkpoint_interval": ROLLOUTS * 100,
...
PRESETS = {
    ...
    "isaac_lab": {
        "models": _make_models,
        "cfg": _make_cfg(),
        "timesteps": DEFAULT_NUM_ENVS * ROLLOUTS * (TOTAL_TRANSITIONS // (DEFAULT_NUM_ENVS * ROLLOUTS)),
        "total_transitions": TOTAL_TRANSITIONS,
        "expected_num_envs": DEFAULT_NUM_ENVS,
        "seed": 10,
    },
}