...
class QuadcopterEnv(PegasusEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        raw_cost = self.cfg.w_pos * pos_cost + self.cfg.w_vel * vel_cost + self.cfg.w_d_action * d_action_cost
    ...
    def _reset_idx(self, env_ids: torch.Tensor):
        ...
        _REWARD_KEYS = ("pos", "vel", "d_action", "total")
