...
for multiple vehicles and use it to perform a simulation, without using PX4 nor ROS.
"""
...
class PegasusApp:
    ...
    def __init__(self):
        ...
        config_multirotor = MultirotorBatchConfig(cfg=cfg_shuttle, n_vehicles=2)

        # Configure one reference trajectory and one results file per vehicle in the batch.
        ...
        _MultirotorBatch = MultirotorBatch(
